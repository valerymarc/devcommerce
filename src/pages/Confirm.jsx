...
import { resetPanier } from '../lib/action';
import '../style.css';
...
const Confirm = () => {
    ...
    return ( <Fragment>
            ...
            <div className="jumbotron text-center">
               ...
               <p className="lead">
                   <strong>
                       Votre commande est en cheminement vers votre lieu de résidence
                   </strong>
                   <br/><br/>
                   <Link className="btn btn-primary bnt-sm" to="/" onClick={()=>{reset()}}>Page d'accueil</Link>
               </p>
               <br/>
             {/*Afiicher les infos du client*/}
           {userProfile.address &&  <ul className="address">
               <li>{userProfile.firstname}, {(userProfile.lastname).toUpperCase()}</li>
